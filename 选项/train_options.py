...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        #tensorboard
        parser.add_argument("--tensorboard_dir", type=str, default='./tensorboard_log/mass_whu_fa',
                        help="Path to the directory of tensorboard log.")
        self.isTrain = True
        return parser