...
inria_images_path_val = "./inria_building_datasets/inria_val_images"
inria_labels_path_val = "./inria_building_datasets/inria_val_labels"
...
if __name__ == "__main__":
    mkdirs(['./mass_inria/valB/images', './mass_inria/valB/labels'])
